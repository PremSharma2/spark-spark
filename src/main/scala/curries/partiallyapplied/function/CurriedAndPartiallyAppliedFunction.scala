...
object CurriedAndPartiallyAppliedFunction extends App {
  // This is called currying series of Function Calls in Scala
  ...
  // pls convert the this method into Function it has two argument list so with remaining list
  ...
  List(1, 2, 3).map(inc)
  //Here Compiler converts this method into the function here actually converts this into lambda
  ...
  val add7_5: Int => Int = simpleAdd(7, _: Int) // same ETA  expansion of normal methods we have curried the function calls of mormal method
  // compiler rewrites it like this y => simpleAdd(7,y)
